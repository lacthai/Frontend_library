...
function OrdersAdminPage() {
    ...
    if (orders.length === 0) {
        return <div className="h-[150vh] flex justify-center items-center">
        <h1 className="text-center pt-4 text-[3rem] text-[#fff] dark:text-black font-bold">No orders yet</h1>
        </div>
    }
